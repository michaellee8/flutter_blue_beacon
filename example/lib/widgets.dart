...
class ScanResultTile extends StatelessWidget {
  const ScanResultTile({Key key, this.result, this.onTap, this.beacon})
      : super(key: key);
  ...
  Widget _buildTitle(BuildContext context) {
    ...
    if (beacon is EddystoneUID) {
      var b = beacon as EddystoneUID;
      infos = [
        Text("FrameType: ${b.frameType.toString()}"),
        Text("NamespaceID: ${b.namespaceId.toString()}"),
        Text("BeaconID: ${b.beaconId.toString()}"),
        Text("tx: ${b.tx.toString()}"),
        Text("rssi: ${b.rssi.toString()}"),
        Text("distance: ${b.distance.toString()}m"),
      ];
    }
