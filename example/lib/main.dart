...
class _FlutterBlueAppState extends State<FlutterBlueApp> {
  ...
  Map<DeviceIdentifier, Beacon> beacons = new Map();
  ...
  _startScan() {
    _scanSubscription = flutterBlueBeacon.scan(
        timeout: const Duration(seconds: 5), types: [BeaconType.EddystoneUID]
        /*withServices: [
      ...
      setState(() {
        scanResults[beacon.scanResult.device.id] = beacon.scanResult;
        beacons[beacon.scanResult.device.id] = beacon;
      });
    }, onDone: _stopScan);
